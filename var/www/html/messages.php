        ...
        <ul class="altMenu">
            ...
            <li><a href="other_calendar.html" title="" class="exp" id="current">Other pages</a>
                <ul>
                    ...
                    <li><a href="other_file_manager.html" class="active">File manager</a></li>
...
<div id="content">
    ...
    <div class="breadLine">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="messages.php" title="">Error Messages</a></li>
            </ul>
        </div>
    ...
    <div class="wrapper">
    	...
    	<!-- File manager -->
        <div class="widget">
            <div class="whead"><h6>Beakers&trade; Messages</h6></div>

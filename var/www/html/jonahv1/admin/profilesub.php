...
file_put_contents('/var/www/html/jonahv1/profiles/tvp-preset.json', $configString); //write
$verified=file_get_contents('/var/www/html/jonahv1/profiles/tvp-preset.json'); //read

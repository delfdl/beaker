<?php 
	...
	$parallel = $config['parallel'];									// read concurrent transcodes
	$passes = $config['passes'];										// read how many passes per transcode (not really implemented, everything is currently '2')
	
	if (!$voddrive) {exit ("error reading config.json<br />ending script to protect file structure"); break;}	// if config.json is corrupt, terminate script
...
<head>
    ...
    <script src="/jonahv1/js/jquery.tablednd.js" type="text/javascript"></script>
...
$(document).ready(function() {
	...
	// http://www.isocra.com/2008/02/table-drag-and-drop-jquery-plugin/
		...
		$('#AjaxResult').load("/jonahv1/server/ajaxTest.php?"+$.tableDnD.serialize());        
		}
	});
...
<?php  include ('/var/www/html/jonahv1/inc/sidebar3.php'); ?>
...
<form action='/jonahv1/inc/transcode-debug.php' method='post'><input type='submit' class='softbutton' value=' click to step thru transcode process >> ' /></form>

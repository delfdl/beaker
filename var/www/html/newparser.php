...
foreach($chunks as $chunk) 
		...
		else 
	{
	  ...
	  if ($bwMin > $overbw_adj) {echo('adjusting Min from '.$bwMin.' to '.$overbw_adj.'<br />');$bwMin = $overbw_adj;}
	  if ($bwMax < $overbw_adj) {echo('adjusting Max from '.$bwMax.' to '.$overbw_adj.'<br />');$bwMax = $overbw_adj;}

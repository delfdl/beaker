...
<?
	$fullPreset=file_get_contents('/home/presets/otvhd.preset'); 				// 	replace by mySql record update (add item to bottom of queue)
...
?>
<option value='libfdk-aac'>libfdk-aac</option><option value='libfaac'>libfaac</option><option value='none'>none</option></select></td>
